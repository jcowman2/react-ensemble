...
See the [Layer Resolution guide](/docs/guides/layers-and-groups#layer-resolution) or [`TrackLayerResolver` type definition](/docs/api/types#tracklayerresolver) for more information.
