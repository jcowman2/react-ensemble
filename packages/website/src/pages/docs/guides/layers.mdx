...
**First Option: Prioritize the first track**

With this resolver, we always choose the `x` value from the first track. Our animation would look like this:
...
**Second Option: Prioritize the last track**

If we always choose the `x` from the last track instead, our animation would look like this:
